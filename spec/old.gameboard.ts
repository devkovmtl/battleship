...
import createGameboard from '../src/Gameboard/old.gameboard'
import createShip from '../src/Ship/ship'

describe.skip('test gameboard factory create gameboard', () => {
...
describe.skip('test place ship on gameboard', () => {
...
describe.skip('test receive attack', () => {
...
describe.skip('test all Ship Sunk', () => {
